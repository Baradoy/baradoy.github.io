...
\section{EXPERIENCE}
    ...
    \item Principal contributor with Elixir, Phoenix, LiveView, Postgres, and GraphQL. Responsible for key architecture and data structures decisions. Collaborating with stakeholders to bring products from inception to launch in a short time.
    ...
    \item Leading small teams building quality products, building the most important things and avoiding expensive distractions.
    \end{itemize}
